...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Lista de Categorias</h1>
    <a href="#" class="btn btn-sm btn-primary shadow-sm mt-2 mt-sm-0" id="abrirCategoria"><i class="fas fa-plus fa-sm text-white-50"></i> Nuevo</a>
</div>
