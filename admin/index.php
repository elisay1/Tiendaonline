    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            if ($resultado > 0) {
                ...
                $alert = '<div class="alert alert-warning text-center alert-dismissible fade show" role="alert">
...
<head>
    ...
    <link rel="shortcut icon" href="../assets/img/devstec.ico" />
</head>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img  src="../assets/img/logo.png" alt="" width="200" height="40">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                    <h3 class="m-0 font-weight-bold text-primary">Hola</h3>
